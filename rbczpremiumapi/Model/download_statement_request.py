...
class DownloadStatementRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const Statement_formatEnum_'pdf' = 'pdf';
    public const Statement_formatEnum_'xml' = 'xml';
    public const Statement_formatEnum_'MT940' = 'MT940';
    ...
    {
        return [
            self::Statement_formatEnum_'pdf',
            self::Statement_formatEnum_'xml',
            self::Statement_formatEnum_'MT940',
        ];
    }
    ...
    */
     ...
     * Sets account_number
     *
     * @param str $account_number Number of the account without prefix and bank code.
     *
     * @return self
     */
     ...
     *
     * @param str $statement_format The format of the statement.
     *
     * @return self
     */
