...
/**
 * GetTransactionList200ResponseTransactionsInnerEntryDetailsTransactionDetailsReferences Class Doc Comment
 *
 * @category Class
 * @package  rbczpremiumapi
 * @author   OpenAPI Generator team
 ...
 */
class GetTransactionList200ResponseTransactionsInnerEntryDetailsTransactionDetailsReferences implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getTransactionList_200_response_transactions_inner_entryDetails_transactionDetails_references';
    ...
    */
     ...
     *
     * @param str|null $end_to_end_identification Originator reference ID - End to End ID; The Originator's reference of the transaction
     *
     * @return self
     */
