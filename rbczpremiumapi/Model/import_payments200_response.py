...
/**
 * ImportPayments200Response Class Doc Comment
 *
 * @category Class
 * @package  rbczpremiumapi
 * @author   OpenAPI Generator team
 ...
 */
class ImportPayments200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'importPayments_200_response';
    ...
    {
        $this->setIfExists('batch_file_id', $data ?? [], null);
    }
    ...
    */
     ...
     * @return int|null
     */
    public function getBatchFileId()
    {
        return $this->container['batch_file_id'];
    }

    /**
     * Sets batch_file_id
     *
     * @param int|null $batch_file_id ID of created batch file
     *
     * @return self
     */
    public function setBatchFileId($batch_file_id)
    {
        if (is_null($batch_file_id)) {
            throw new \InvalidArgumentException('non-nullable batch_file_id cannot be null');
        }
        $this->container['batch_file_id'] = $batch_file_id;
