...
/**
 * GetTransactionList200ResponseTransactionsInnerEntryDetailsTransactionDetailsRelatedPartiesCounterPartyAccount Class Doc Comment
 *
 * @category Class
 * @package  rbczpremiumapi
 * @author   OpenAPI Generator team
 ...
 */
class GetTransactionList200ResponseTransactionsInnerEntryDetailsTransactionDetailsRelatedPartiesCounterPartyAccount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getTransactionList_200_response_transactions_inner_entryDetails_transactionDetails_relatedParties_counterParty_account';
    ...
    */
     ...
     * Sets iban
     *
     * @param str|null $iban IBAN code of the bank account if available
     *
     * @return self
     */
     ...
     *
     * @param str|null $account_number_prefix Prefix part of the bank account number (only for czech accounts)
     *
     * @return self
     */
     ...
     * Sets account_number
     *
     * @param str|null $account_number Base part of the bank account number in czech fromat or in foreign format
     *
     * @return self
     */
