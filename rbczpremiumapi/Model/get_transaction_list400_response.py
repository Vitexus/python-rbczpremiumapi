...
/**
 * GetTransactionList400Response Class Doc Comment
 *
 * @category Class
 * @package  rbczpremiumapi
 * @author   OpenAPI Generator team
 ...
 */
class GetTransactionList400Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getTransactionList_400_response';
    ...
    */
     ...
     * Sets error
     *
     * @param str|null $error Invalid date. Parameter `from` must not be older than 90 days.
     *
     * @return self
     */
