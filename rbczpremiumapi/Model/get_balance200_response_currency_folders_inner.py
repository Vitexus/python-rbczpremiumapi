...
class GetBalance200ResponseCurrencyFoldersInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'currency' => 'str',
        'status' => 'str',
        'balances' => 'List[GetBalance200ResponseCurrencyFoldersInnerBalancesInner]'
    ];
    ...
    */
     ...
     * Sets currency
     *
     * @param str $currency The currency of the currency folder
     *
     * @return self
     */
     ...
     * Sets status
     *
     * @param str $status The status of the currency folder (CATALOG: CURRENCYFOLDERSTATUS)
     *
     * @return self
     */
     ...
     * Gets balances
     *
     * @return List[GetBalance200ResponseCurrencyFoldersInnerBalancesInner]|null
     */
     ...
     * Sets balances
     *
     * @param List[GetBalance200ResponseCurrencyFoldersInnerBalancesInner]|null $balances the balances of the currencyFolder
     *
     * @return self
     */
