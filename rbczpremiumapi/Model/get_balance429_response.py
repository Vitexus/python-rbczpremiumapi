 ...
 */
class GetBalance429Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getBalance_429_response';
    ...
    public const ErrorEnum_'TOO_MANY_REQUESTS' = 'TOO_MANY_REQUESTS';
    ...
    {
        return [
            self::ErrorEnum_'TOO_MANY_REQUESTS',
        ];
    }
