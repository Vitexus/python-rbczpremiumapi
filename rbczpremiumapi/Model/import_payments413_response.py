...
class ImportPayments413Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const ErrorEnum_'BATCH_CONTENT_SIZE_EXCEEDED - Content exceeds maximum of 200 MB' = 'BATCH_CONTENT_SIZE_EXCEEDED - Content exceeds maximum of 200 MB';
    ...
    {
        return [
            self::ErrorEnum_'BATCH_CONTENT_SIZE_EXCEEDED - Content exceeds maximum of 200 MB',
        ];
    }
