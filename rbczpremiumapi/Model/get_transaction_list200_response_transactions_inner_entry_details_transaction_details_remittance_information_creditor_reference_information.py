...
/**
 * GetTransactionList200ResponseTransactionsInnerEntryDetailsTransactionDetailsRemittanceInformationCreditorReferenceInformation Class Doc Comment
 *
 * @category Class
 * @package  rbczpremiumapi
 * @author   OpenAPI Generator team
 ...
 */
class GetTransactionList200ResponseTransactionsInnerEntryDetailsTransactionDetailsRemittanceInformationCreditorReferenceInformation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getTransactionList_200_response_transactions_inner_entryDetails_transactionDetails_remittanceInformation_creditorReferenceInformation';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('constant', $data ?? [], null);
        $this->setIfExists('specific', $data ?? [], null);
    }
    ...
    */
     ...
     * Sets variable
     *
     * @param str|null $variable Variable symbol
     *
     * @return self
     */
     ...
     * Sets constant
     *
     * @param str|null $constant Constant symbol
     *
     * @return self
     */
    ...
    {
        if (is_null($constant)) {
            throw new \InvalidArgumentException('non-nullable constant cannot be null');
        }
    ...
    {
        return $this->container['specific'];
    }

    /**
     * Sets specific
     *
     * @param str|null $specific Specific symbol
     *
     * @return self
     */
    ...
    {
        if (is_null($specific)) {
            throw new \InvalidArgumentException('non-nullable specific cannot be null');
        }
        $this->container['specific'] = $specific;
