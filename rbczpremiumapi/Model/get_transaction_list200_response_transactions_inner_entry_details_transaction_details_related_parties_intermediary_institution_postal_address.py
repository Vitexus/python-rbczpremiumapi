...
/**
 * GetTransactionList200ResponseTransactionsInnerEntryDetailsTransactionDetailsRelatedPartiesIntermediaryInstitutionPostalAddress Class Doc Comment
 *
 * @category Class
 * @package  rbczpremiumapi
 * @author   OpenAPI Generator team
 ...
 */
class GetTransactionList200ResponseTransactionsInnerEntryDetailsTransactionDetailsRelatedPartiesIntermediaryInstitutionPostalAddress implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getTransactionList_200_response_transactions_inner_entryDetails_transactionDetails_relatedParties_intermediaryInstitution_postalAddress';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('short_address', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['short_address'];
    }

    /**
     * Sets short_address
     *
     * @param str|null $short_address Short address
     *
     * @return self
     */
    public function setShortAddress($short_address)
    {
        if (is_null($short_address)) {
            throw new \InvalidArgumentException('non-nullable short_address cannot be null');
        }
        $this->container['short_address'] = $short_address;
