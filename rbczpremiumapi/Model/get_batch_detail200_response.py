 ...
 */
class GetBatchDetail200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getBatchDetail_200_response';
    ...
    protected static $openAPITypes = [
        'batch_name' => 'str',
        'batch_file_status' => 'str',
        'create_date' => 'date',
        'batch_items' => 'List[GetBatchDetail200ResponseBatchItemsInner]'
    ];
    ...
    protected static $setters = [
        ...
        'batch_file_status' => 'setBatchFileStatus',
        'create_date' => 'setCreateDate',
        'batch_items' => 'setBatchItems'
    ];
    ...
    protected static $getters = [
        ...
        'batch_file_status' => 'getBatchFileStatus',
        'create_date' => 'getCreateDate',
        'batch_items' => 'getBatchItems'
    ];
    ...
    public const Batch_file_statusEnum_'DELETED' = 'DELETED';
    public const Batch_file_statusEnum_'OK' = 'OK';
    public const Batch_file_statusEnum_'UPLOADED' = 'UPLOADED';
    public const Batch_file_statusEnum_'PROCESSING' = 'PROCESSING';
    public const Batch_file_statusEnum_'ERROR' = 'ERROR';
    ...
    {
        return [
            self::Batch_file_statusEnum_'DELETED',
            self::Batch_file_statusEnum_'OK',
            self::Batch_file_statusEnum_'UPLOADED',
            self::Batch_file_statusEnum_'PROCESSING',
            self::Batch_file_statusEnum_'ERROR',
        ];
    }
    ...
    {
        $this->setIfExists('batch_name', $data ?? [], null);
        $this->setIfExists('batch_file_status', $data ?? [], null);
        $this->setIfExists('create_date', $data ?? [], null);
        $this->setIfExists('batch_items', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['batch_file_status']) && !in_array($this->container['batch_file_status'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'batch_file_status', must be one of '%s'",
                $this->container['batch_file_status'],
     ...
     * Sets batch_name
     *
     * @param str|null $batch_name Batch name
     *
     * @return self
     */
    public function setBatchName($batch_name)
    {
        if (is_null($batch_name)) {
            throw new \InvalidArgumentException('non-nullable batch_name cannot be null');
        }
    ...
    /**
     * Gets batch_file_status
     *
     * @return str|null
     */
    public function getBatchFileStatus()
    {
        return $this->container['batch_file_status'];
    }

    /**
     * Sets batch_file_status
     *
     * @param str|null $batch_file_status Status of batch file import
     *
     * @return self
     */
    public function setBatchFileStatus($batch_file_status)
    {
        if (is_null($batch_file_status)) {
            throw new \InvalidArgumentException('non-nullable batch_file_status cannot be null');
        }
        $allowedValues = $this->getBatchFileStatusAllowableValues();
        if (!in_array($batch_file_status, $allowedValues, true)) {
        ...
        $this->container['batch_file_status'] = $batch_file_status;
     ...
     * Sets create_date
     *
     * @param date|null $create_date The date when the batch was created
     *
     * @return self
     */
     ...
     * Gets batch_items
     *
     * @return List[GetBatchDetail200ResponseBatchItemsInner]|null
     */
    public function getBatchItems()
    {
        return $this->container['batch_items'];
    }

    /**
     * Sets batch_items
     *
     * @param List[GetBatchDetail200ResponseBatchItemsInner]|null $batch_items batch_items
     *
     * @return self
     */
    public function setBatchItems($batch_items)
    {
        if (is_null($batch_items)) {
            throw new \InvalidArgumentException('non-nullable batch_items cannot be null');
        }
        $this->container['batch_items'] = $batch_items;
