 ...
 */
class ImportPayments400Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'importPayments_400_response';
    ...
    public const ErrorEnum_'INVALID_BATCH_IMPORT_FORMAT' = 'INVALID_BATCH_IMPORT_FORMAT';
    public const ErrorEnum_'BATCH_CONTENT_INVALID' = 'BATCH_CONTENT_INVALID';
    public const ErrorEnum_'BATCH_ALREADY_IMPORTED' = 'BATCH_ALREADY_IMPORTED';
    ...
    {
        return [
            self::ErrorEnum_'INVALID_BATCH_IMPORT_FORMAT',
            self::ErrorEnum_'BATCH_CONTENT_INVALID',
            self::ErrorEnum_'BATCH_ALREADY_IMPORTED',
        ];
    }
    ...
    */
     ...
     * Sets error
     *
     * @param str|null $error * INVALID_BATCH_IMPORT_FORMAT - Batch-Import-Format unsupported * BATCH_CONTENT_INVALID - Batch content doesn't match to declared Batch-Import-Format * BATCH_ALREADY_IMPORTED - Batch has already been imported (based on checksum) 
     *
     * @return self
     */
