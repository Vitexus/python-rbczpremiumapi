...
/**
 * GetTransactionList200Response Class Doc Comment
 *
 * @category Class
 * @package  rbczpremiumapi
 * @author   OpenAPI Generator team
 ...
 */
class GetTransactionList200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getTransactionList_200_response';
    ...
    protected static $openAPITypes = [
        'last_page' => 'bool',
        'transactions' => 'List[GetTransactionList200ResponseTransactionsInner]'
    ];
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['transactions']) && (count($this->container['transactions']) < 0)) {
            $invalidProperties[] = "invalid value for 'transactions', number of items must be greater than or equal to 0.";
        }
     ...
     * Sets last_page
     *
     * @param bool|null $last_page Indication wheter the page is last - default false
     *
     * @return self
     */
     ...
     * Gets transactions
     *
     * @return List[GetTransactionList200ResponseTransactionsInner]|null
     */
     ...
     * Sets transactions
     *
     * @param List[GetTransactionList200ResponseTransactionsInner]|null $transactions An array of transactions.
     *
     * @return self
     */
    public function setTransactions($transactions)
    {
        ...
        if ((count($transactions) < 0)) {
            throw new \InvalidArgumentException('invalid length for $transactions when calling GetTransactionList200Response., number of items must be greater than or equal to 0.');
        }
