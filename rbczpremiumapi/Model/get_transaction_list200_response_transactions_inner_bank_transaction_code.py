...
/**
 * GetTransactionList200ResponseTransactionsInnerBankTransactionCode Class Doc Comment
 *
 * @category Class
 * @package  rbczpremiumapi
 * @author   OpenAPI Generator team
 ...
 */
class GetTransactionList200ResponseTransactionsInnerBankTransactionCode implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getTransactionList_200_response_transactions_inner_bankTransactionCode';
    ...
    */
     ...
     * Sets code
     *
     * @param str $code Transaction code in ISO20022 camt.53 format (e.g. 10000101000 - Odchozi tuzemska platba).
     *
     * @return self
     */
