...
/**
 * GetBalance403Response Class Doc Comment
 *
 * @category Class
 * @package  rbczpremiumapi
 * @author   OpenAPI Generator team
 ...
 */
class GetBalance403Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getBalance_403_response';
    ...
    public const ErrorEnum_'INSUFFICIENT_RIGHTS' = 'INSUFFICIENT_RIGHTS';
    ...
    {
        return [
            self::ErrorEnum_'INSUFFICIENT_RIGHTS',
        ];
    }
