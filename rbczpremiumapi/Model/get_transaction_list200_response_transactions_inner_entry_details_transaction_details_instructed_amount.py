...
/**
 * GetTransactionList200ResponseTransactionsInnerEntryDetailsTransactionDetailsInstructedAmount Class Doc Comment
 *
 * @category Class
 ...
 */
class GetTransactionList200ResponseTransactionsInnerEntryDetailsTransactionDetailsInstructedAmount implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'getTransactionList_200_response_transactions_inner_entryDetails_transactionDetails_instructedAmount';
    ...
    */
     ...
     * Sets currency
     *
     * @param str $currency Currency code of the amount
     *
     * @return self
     */
