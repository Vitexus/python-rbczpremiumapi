...
class GetBatchDetailApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['get_batch_detail'] to see the possible values for this operation
     *
     * @throws \rbczpremiumapi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return GetBatchDetail200Response|GetBatchDetail400Response|GetBalance401Response|GetBalance403Response|GetBalance404Response|GetBalance429Response
     */
    public function get_batch_detail($x_ibm_client_id, $x_request_id, $batch_file_id, $psu_ip_address = null, string $contentType = self::contentTypes['get_batch_detail'][0])
    {
        list($response) = $this->get_batch_detailWithHttpInfo($x_ibm_client_id, $x_request_id, $batch_file_id, $psu_ip_address, $contentType);
        return $response;
    }

    /**
     * Operation get_batch_detailWithHttpInfo
     *
     * @param  str $x_ibm_client_id ClientID obtained from Developer Portal - when you registered your app with us. (required)
     * @param  str $x_request_id Unique request id provided by consumer application for reference and auditing. (required)
     * @param  int $batch_file_id Batch file id  (required)
     ...
     * @throws \rbczpremiumapi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of GetBatchDetail200Response|GetBatchDetail400Response|GetBalance401Response|GetBalance403Response|GetBalance404Response|GetBalance429Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function get_batch_detailWithHttpInfo($x_ibm_client_id, $x_request_id, $batch_file_id, $psu_ip_address = null, string $contentType = self::contentTypes['get_batch_detail'][0])
    {
        $request = $this->get_batch_detailRequest($x_ibm_client_id, $x_request_id, $batch_file_id, $psu_ip_address, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('GetBatchDetail200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('GetBatchDetail200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, 'GetBatchDetail200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders(),
                    ];
                case 400:
                    if ('GetBatchDetail400Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('GetBatchDetail400Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, \JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, 'GetBatchDetail400Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders(),
                    ];
                case 401:
            ...
            $returnType = 'GetBatchDetail200Response';
    ...
    /**
     * Operation get_batch_detailAsync
     *
     * @param  str $x_ibm_client_id ClientID obtained from Developer Portal - when you registered your app with us. (required)
     * @param  str $x_request_id Unique request id provided by consumer application for reference and auditing. (required)
     * @param  int $batch_file_id Batch file id  (required)
     ...
     */
    public function get_batch_detailAsync($x_ibm_client_id, $x_request_id, $batch_file_id, $psu_ip_address = null, string $contentType = self::contentTypes['get_batch_detail'][0])
    {
        return $this->get_batch_detailAsyncWithHttpInfo($x_ibm_client_id, $x_request_id, $batch_file_id, $psu_ip_address, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation get_batch_detailAsyncWithHttpInfo
     *
     * @param  str $x_ibm_client_id ClientID obtained from Developer Portal - when you registered your app with us. (required)
     * @param  str $x_request_id Unique request id provided by consumer application for reference and auditing. (required)
     * @param  int $batch_file_id Batch file id  (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function get_batch_detailAsyncWithHttpInfo($x_ibm_client_id, $x_request_id, $batch_file_id, $psu_ip_address = null, string $contentType = self::contentTypes['get_batch_detail'][0])
    {
        $returnType = 'GetBatchDetail200Response';
        $request = $this->get_batch_detailRequest($x_ibm_client_id, $x_request_id, $batch_file_id, $psu_ip_address, $contentType);
    ...
    /**
     * Create request for operation 'get_batch_detail'
     *
     * @param  str $x_ibm_client_id ClientID obtained from Developer Portal - when you registered your app with us. (required)
     * @param  str $x_request_id Unique request id provided by consumer application for reference and auditing. (required)
     * @param  int $batch_file_id Batch file id  (required)
     ...
     */
    public function get_batch_detailRequest($x_ibm_client_id, $x_request_id, $batch_file_id, $psu_ip_address = null, string $contentType = self::contentTypes['get_batch_detail'][0])
    {
        ...
        if ($x_ibm_client_id === null || (is_array($x_ibm_client_id) && count($x_ibm_client_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_ibm_client_id when calling get_batch_detail'
            );
        }
        ...
        if ($x_request_id === null || (is_array($x_request_id) && count($x_request_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_request_id when calling get_batch_detail'
            );
        }
        if (\strlen((string) $x_request_id) > 60) {
            throw new \InvalidArgumentException('invalid length for "$x_request_id" when calling GetBatchDetailApi.get_batch_detail, must be smaller than or equal to 60.');
        }
        if (!preg_match("/[a-zA-Z0-9\-_:]{1,60}/", (string) $x_request_id)) {
            throw new \InvalidArgumentException("invalid value for \"x_request_id\" when calling GetBatchDetailApi.get_batch_detail, must conform to the pattern /[a-zA-Z0-9\-_:]{1,60}/.");
        }
        
        // verify the required parameter 'batch_file_id' is set
        if ($batch_file_id === null || (is_array($batch_file_id) && count($batch_file_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $batch_file_id when calling get_batch_detail'
            );
        }

        if ($psu_ip_address !== null && \strlen((string) $psu_ip_address) > 39) {
            throw new \InvalidArgumentException('invalid length for "$psu_ip_address" when calling GetBatchDetailApi.get_batch_detail, must be smaller than or equal to 39.');
        }
