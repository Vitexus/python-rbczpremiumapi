...
class GetFxRatesListApi
{
     ...
     * @param  date|null $var_date The effective date for which the FX rates list is requested. Will default to **now** when not specified. (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['get_fx_rates_list'] to see the possible values for this operation
     *
     ...
     */
    public function get_fx_rates_list($x_ibm_client_id, $x_request_id, $psu_ip_address = null, $var_date = null, string $contentType = self::contentTypes['get_fx_rates_list'][0])
    {
        list($response) = $this->get_fx_rates_listWithHttpInfo($x_ibm_client_id, $x_request_id, $psu_ip_address, $var_date, $contentType);
        return $response;
    }

    /**
     * Operation get_fx_rates_listWithHttpInfo
     *
     * @param  str $x_ibm_client_id ClientID obtained from Developer Portal - when you registered your app with us. (required)
     * @param  str $x_request_id Unique request id provided by consumer application for reference and auditing. (required)
     * @param  str|null $psu_ip_address IP address of a client - the end IP address of the client application (no server) in IPv4 or IPv6 format. If the bank client (your user) uses a browser by which he accesses your server app, we need to know the IP address of his browser. Always provide the closest IP address to the real end-user possible. (optional)
     ...
     */
    public function get_fx_rates_listWithHttpInfo($x_ibm_client_id, $x_request_id, $psu_ip_address = null, $var_date = null, string $contentType = self::contentTypes['get_fx_rates_list'][0])
    {
        $request = $this->get_fx_rates_listRequest($x_ibm_client_id, $x_request_id, $psu_ip_address, $var_date, $contentType);
    ...
    /**
     * Operation get_fx_rates_listAsync
     *
     * @param  str $x_ibm_client_id ClientID obtained from Developer Portal - when you registered your app with us. (required)
     * @param  str $x_request_id Unique request id provided by consumer application for reference and auditing. (required)
     * @param  str|null $psu_ip_address IP address of a client - the end IP address of the client application (no server) in IPv4 or IPv6 format. If the bank client (your user) uses a browser by which he accesses your server app, we need to know the IP address of his browser. Always provide the closest IP address to the real end-user possible. (optional)
     ...
     */
    public function get_fx_rates_listAsync($x_ibm_client_id, $x_request_id, $psu_ip_address = null, $var_date = null, string $contentType = self::contentTypes['get_fx_rates_list'][0])
    {
        return $this->get_fx_rates_listAsyncWithHttpInfo($x_ibm_client_id, $x_request_id, $psu_ip_address, $var_date, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation get_fx_rates_listAsyncWithHttpInfo
     *
     * @param  str $x_ibm_client_id ClientID obtained from Developer Portal - when you registered your app with us. (required)
     * @param  str $x_request_id Unique request id provided by consumer application for reference and auditing. (required)
     * @param  str|null $psu_ip_address IP address of a client - the end IP address of the client application (no server) in IPv4 or IPv6 format. If the bank client (your user) uses a browser by which he accesses your server app, we need to know the IP address of his browser. Always provide the closest IP address to the real end-user possible. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function get_fx_rates_listAsyncWithHttpInfo($x_ibm_client_id, $x_request_id, $psu_ip_address = null, $var_date = null, string $contentType = self::contentTypes['get_fx_rates_list'][0])
    {
        $returnType = 'CurrencyListSimple';
        $request = $this->get_fx_rates_listRequest($x_ibm_client_id, $x_request_id, $psu_ip_address, $var_date, $contentType);
    ...
    /**
     * Create request for operation 'get_fx_rates_list'
     *
     * @param  str $x_ibm_client_id ClientID obtained from Developer Portal - when you registered your app with us. (required)
     * @param  str $x_request_id Unique request id provided by consumer application for reference and auditing. (required)
     * @param  str|null $psu_ip_address IP address of a client - the end IP address of the client application (no server) in IPv4 or IPv6 format. If the bank client (your user) uses a browser by which he accesses your server app, we need to know the IP address of his browser. Always provide the closest IP address to the real end-user possible. (optional)
     ...
     */
    public function get_fx_rates_listRequest($x_ibm_client_id, $x_request_id, $psu_ip_address = null, $var_date = null, string $contentType = self::contentTypes['get_fx_rates_list'][0])
    {
        ...
        if ($x_ibm_client_id === null || (is_array($x_ibm_client_id) && count($x_ibm_client_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_ibm_client_id when calling get_fx_rates_list'
            );
        }
        ...
        if ($x_request_id === null || (is_array($x_request_id) && count($x_request_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_request_id when calling get_fx_rates_list'
            );
        }
        if (\strlen((string) $x_request_id) > 60) {
            throw new \InvalidArgumentException('invalid length for "$x_request_id" when calling GetFxRatesListApi.get_fx_rates_list, must be smaller than or equal to 60.');
        }
        if (!preg_match("/[a-zA-Z0-9\-_:]{1,60}/", (string) $x_request_id)) {
            throw new \InvalidArgumentException("invalid value for \"x_request_id\" when calling GetFxRatesListApi.get_fx_rates_list, must conform to the pattern /[a-zA-Z0-9\-_:]{1,60}/.");
        }
        
        if ($psu_ip_address !== null && \strlen((string) $psu_ip_address) > 39) {
            throw new \InvalidArgumentException('invalid length for "$psu_ip_address" when calling GetFxRatesListApi.get_fx_rates_list, must be smaller than or equal to 39.');
        }
