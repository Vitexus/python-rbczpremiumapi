...
class GetAccountsApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['get_accounts'] to see the possible values for this operation
     *
     * @throws \rbczpremiumapi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return GetAccounts200Response|GetBalance401Response|GetBalance403Response|GetBalance429Response
     */
    public function get_accounts($x_ibm_client_id, $x_request_id, $psu_ip_address = null, $page = null, $size = null, string $contentType = self::contentTypes['get_accounts'][0])
    {
        list($response) = $this->get_accountsWithHttpInfo($x_ibm_client_id, $x_request_id, $psu_ip_address, $page, $size, $contentType);
        return $response;
    }

    /**
     * Operation get_accountsWithHttpInfo
     *
     * @param  str $x_ibm_client_id ClientID obtained from Developer Portal - when you registered your app with us. (required)
     * @param  str $x_request_id Unique request id provided by consumer application for reference and auditing. (required)
     * @param  str|null $psu_ip_address IP address of a client - the end IP address of the client application (no server) in IPv4 or IPv6 format. If the bank client (your user) uses a browser by which he accesses your server app, we need to know the IP address of his browser. Always provide the closest IP address to the real end-user possible. (optional)
     ...
     * @throws \rbczpremiumapi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of GetAccounts200Response|GetBalance401Response|GetBalance403Response|GetBalance429Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function get_accountsWithHttpInfo($x_ibm_client_id, $x_request_id, $psu_ip_address = null, $page = null, $size = null, string $contentType = self::contentTypes['get_accounts'][0])
    {
        $request = $this->get_accountsRequest($x_ibm_client_id, $x_request_id, $psu_ip_address, $page, $size, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('GetAccounts200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('GetAccounts200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, 'GetAccounts200Response', []),
            ...
            $returnType = 'GetAccounts200Response';
     ...
     */
    public function get_accountsAsync($x_ibm_client_id, $x_request_id, $psu_ip_address = null, $page = null, $size = null, string $contentType = self::contentTypes['get_accounts'][0])
    {
        return $this->get_accountsAsyncWithHttpInfo($x_ibm_client_id, $x_request_id, $psu_ip_address, $page, $size, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation get_accountsAsyncWithHttpInfo
     *
     * @param  str $x_ibm_client_id ClientID obtained from Developer Portal - when you registered your app with us. (required)
     * @param  str $x_request_id Unique request id provided by consumer application for reference and auditing. (required)
     * @param  str|null $psu_ip_address IP address of a client - the end IP address of the client application (no server) in IPv4 or IPv6 format. If the bank client (your user) uses a browser by which he accesses your server app, we need to know the IP address of his browser. Always provide the closest IP address to the real end-user possible. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function get_accountsAsyncWithHttpInfo($x_ibm_client_id, $x_request_id, $psu_ip_address = null, $page = null, $size = null, string $contentType = self::contentTypes['get_accounts'][0])
    {
        $returnType = 'GetAccounts200Response';
        $request = $this->get_accountsRequest($x_ibm_client_id, $x_request_id, $psu_ip_address, $page, $size, $contentType);
    ...
    /**
     * Create request for operation 'get_accounts'
     *
     * @param  str $x_ibm_client_id ClientID obtained from Developer Portal - when you registered your app with us. (required)
     * @param  str $x_request_id Unique request id provided by consumer application for reference and auditing. (required)
     * @param  str|null $psu_ip_address IP address of a client - the end IP address of the client application (no server) in IPv4 or IPv6 format. If the bank client (your user) uses a browser by which he accesses your server app, we need to know the IP address of his browser. Always provide the closest IP address to the real end-user possible. (optional)
     ...
     */
    public function get_accountsRequest($x_ibm_client_id, $x_request_id, $psu_ip_address = null, $page = null, $size = null, string $contentType = self::contentTypes['get_accounts'][0])
    {
        ...
        if ($x_ibm_client_id === null || (is_array($x_ibm_client_id) && count($x_ibm_client_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_ibm_client_id when calling get_accounts'
            );
        }
        ...
        if ($x_request_id === null || (is_array($x_request_id) && count($x_request_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_request_id when calling get_accounts'
            );
        }
        if (\strlen((string) $x_request_id) > 60) {
            throw new \InvalidArgumentException('invalid length for "$x_request_id" when calling GetAccountsApi.get_accounts, must be smaller than or equal to 60.');
        }
        if (!preg_match("/[a-zA-Z0-9\-_:]{1,60}/", (string) $x_request_id)) {
            throw new \InvalidArgumentException("invalid value for \"x_request_id\" when calling GetAccountsApi.get_accounts, must conform to the pattern /[a-zA-Z0-9\-_:]{1,60}/.");
        }
        
        if ($psu_ip_address !== null && \strlen((string) $psu_ip_address) > 39) {
            throw new \InvalidArgumentException('invalid length for "$psu_ip_address" when calling GetAccountsApi.get_accounts, must be smaller than or equal to 39.');
        }
