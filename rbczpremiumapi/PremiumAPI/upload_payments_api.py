...
class UploadPaymentsApi
{
     ...
     * @param  str $batch_import_format Format of imported batch. For CCT format please use option SEPA-XML. (required)
     * @param  str $request_body request_body (required)
     ...
     * @param  str|null $batch_name Batch name, if not present then will be generated in format &#x60;ImportApi_&lt;DDMMYYYY&gt;&#x60;.  If the name is longer than 50 characters, it will be truncated   (optional)
     * @param  bool|null $batch_combined_payments Optional header for combined payments. Payments inside the import file are considered as combined in case the header is present and its value is set to &#39;true&#39;.  (optional, default to False)
     * @param  bool|null $batch_autocorrect Flag if valueDate should be autocorrected in the imported file or not. Autocorrection moved valueDate on first available valid  (working) day. Beware that this may affect if the payment will be sent as instant or not since only payments with valueDate same as actual date (during sending of payment to bank) can be sent as instant.  (optional, default to True)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['import_payments'] to see the possible values for this operation
     *
     * @throws \rbczpremiumapi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return ImportPayments200Response|ImportPayments400Response|GetBalance401Response|GetBalance403Response|ImportPayments413Response|ImportPayments415Response|GetBalance429Response|ImportPayments415Response
     */
    public function import_payments($x_ibm_client_id, $x_request_id, $batch_import_format, $request_body, $psu_ip_address = null, $batch_name = null, $batch_combined_payments = False, $batch_autocorrect = True, string $contentType = self::contentTypes['import_payments'][0])
    {
        list($response) = $this->import_paymentsWithHttpInfo($x_ibm_client_id, $x_request_id, $batch_import_format, $request_body, $psu_ip_address, $batch_name, $batch_combined_payments, $batch_autocorrect, $contentType);
        return $response;
    }

    /**
     * Operation import_paymentsWithHttpInfo
     *
     * @param  str $x_ibm_client_id ClientID obtained from Developer Portal - when you registered your app with us. (required)
     * @param  str $x_request_id Unique request id provided by consumer application for reference and auditing. (required)
     * @param  str $batch_import_format Format of imported batch. For CCT format please use option SEPA-XML. (required)
     ...
     * @throws \rbczpremiumapi\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of ImportPayments200Response|ImportPayments400Response|GetBalance401Response|GetBalance403Response|ImportPayments413Response|ImportPayments415Response|GetBalance429Response|ImportPayments415Response, HTTP status code, HTTP response headers (array of strings)
     */
    public function import_paymentsWithHttpInfo($x_ibm_client_id, $x_request_id, $batch_import_format, $request_body, $psu_ip_address = null, $batch_name = null, $batch_combined_payments = False, $batch_autocorrect = True, string $contentType = self::contentTypes['import_payments'][0])
    {
        $request = $this->import_paymentsRequest($x_ibm_client_id, $x_request_id, $batch_import_format, $request_body, $psu_ip_address, $batch_name, $batch_combined_payments, $batch_autocorrect, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('ImportPayments200Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('ImportPayments200Response' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, 'ImportPayments200Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders(),
                    ];
                case 400:
                    if ('ImportPayments400Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('ImportPayments400Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, \JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, 'ImportPayments400Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders(),
                    ];
                case 401:
                ...
                case 413:
                    if ('ImportPayments413Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('ImportPayments413Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, \JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, 'ImportPayments413Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders(),
                    ];
                case 415:
                    if ('ImportPayments415Response' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('ImportPayments415Response' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, \JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, 'ImportPayments415Response', []),
                        $response->getStatusCode(),
                        $response->getHeaders(),
                    ];
                case 429:
            ...
            $returnType = 'ImportPayments200Response';
    ...
    /**
     * Operation import_paymentsAsync
     *
     * @param  str $x_ibm_client_id ClientID obtained from Developer Portal - when you registered your app with us. (required)
     * @param  str $x_request_id Unique request id provided by consumer application for reference and auditing. (required)
     * @param  str $batch_import_format Format of imported batch. For CCT format please use option SEPA-XML. (required)
     ...
     */
    public function import_paymentsAsync($x_ibm_client_id, $x_request_id, $batch_import_format, $request_body, $psu_ip_address = null, $batch_name = null, $batch_combined_payments = False, $batch_autocorrect = True, string $contentType = self::contentTypes['import_payments'][0])
    {
        return $this->import_paymentsAsyncWithHttpInfo($x_ibm_client_id, $x_request_id, $batch_import_format, $request_body, $psu_ip_address, $batch_name, $batch_combined_payments, $batch_autocorrect, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation import_paymentsAsyncWithHttpInfo
     *
     * @param  str $x_ibm_client_id ClientID obtained from Developer Portal - when you registered your app with us. (required)
     * @param  str $x_request_id Unique request id provided by consumer application for reference and auditing. (required)
     * @param  str $batch_import_format Format of imported batch. For CCT format please use option SEPA-XML. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function import_paymentsAsyncWithHttpInfo($x_ibm_client_id, $x_request_id, $batch_import_format, $request_body, $psu_ip_address = null, $batch_name = null, $batch_combined_payments = False, $batch_autocorrect = True, string $contentType = self::contentTypes['import_payments'][0])
    {
        $returnType = 'ImportPayments200Response';
        $request = $this->import_paymentsRequest($x_ibm_client_id, $x_request_id, $batch_import_format, $request_body, $psu_ip_address, $batch_name, $batch_combined_payments, $batch_autocorrect, $contentType);
    ...
    /**
     * Create request for operation 'import_payments'
     *
     * @param  str $x_ibm_client_id ClientID obtained from Developer Portal - when you registered your app with us. (required)
     * @param  str $x_request_id Unique request id provided by consumer application for reference and auditing. (required)
     * @param  str $batch_import_format Format of imported batch. For CCT format please use option SEPA-XML. (required)
     ...
     */
    public function import_paymentsRequest($x_ibm_client_id, $x_request_id, $batch_import_format, $request_body, $psu_ip_address = null, $batch_name = null, $batch_combined_payments = False, $batch_autocorrect = True, string $contentType = self::contentTypes['import_payments'][0])
    {
        ...
        if ($x_ibm_client_id === null || (is_array($x_ibm_client_id) && count($x_ibm_client_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_ibm_client_id when calling import_payments'
            );
        }
        ...
        if ($x_request_id === null || (is_array($x_request_id) && count($x_request_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $x_request_id when calling import_payments'
            );
        }
        if (\strlen((string) $x_request_id) > 60) {
            throw new \InvalidArgumentException('invalid length for "$x_request_id" when calling UploadPaymentsApi.import_payments, must be smaller than or equal to 60.');
        }
        if (!preg_match("/[a-zA-Z0-9\-_:]{1,60}/", (string) $x_request_id)) {
            throw new \InvalidArgumentException("invalid value for \"x_request_id\" when calling UploadPaymentsApi.import_payments, must conform to the pattern /[a-zA-Z0-9\-_:]{1,60}/.");
        }
        ...
        if ($batch_import_format === null || (is_array($batch_import_format) && count($batch_import_format) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $batch_import_format when calling import_payments'
            );
        }
        ...
        if ($request_body === null || (is_array($request_body) && count($request_body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $request_body when calling import_payments'
            );
        }

        if ($psu_ip_address !== null && \strlen((string) $psu_ip_address) > 39) {
            throw new \InvalidArgumentException('invalid length for "$psu_ip_address" when calling UploadPaymentsApi.import_payments, must be smaller than or equal to 39.');
        }
        
        if ($batch_name !== null && \strlen((string) $batch_name) > 50) {
            throw new \InvalidArgumentException('invalid length for "$batch_name" when calling UploadPaymentsApi.import_payments, must be smaller than or equal to 50.');
        }
        ...
        if ($batch_combined_payments !== null) {
            $headerParams['Batch-Combined-Payments'] = ObjectSerializer::toHeaderValue($batch_combined_payments);
        }
        // header params
        if ($batch_autocorrect !== null) {
            $headerParams['Batch-Autocorrect'] = ObjectSerializer::toHeaderValue($batch_autocorrect);
        }
